...
ggmap(world) + 
  geom_point(data = Starbucks, 
             aes(x = Longitude, y = Latitude, color = Ownership Type), #why is this wrong
             alpha = .3, 
             size = .1) +
  theme_map()
```
...
ggmap(twin_cities) +
  ...
  annotate("point",
           ...
           xmin = -93.16157,
           y = 44.93404,
           ymin = 44.94153, # how to use xmin, xmax for coordinates
           color = "red",
           label = "Macalester") +
  theme_map()
```
...
favorite_plcs_chloe <- tibble(
  place = c("Home", "Dong Chun Hong", "Clair's", 
            "Uchi", "La Madeleine", "Super Chix",
            "Hmart", "Cauldron", "Gold dust Tattoo", "Fatstraws" ),
  long = c(),
  lat = c(),
  top_three = c("Home","Clair's", "Hmart"))
```
